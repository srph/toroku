...
<br>
If that doesn't work, you please paste this link to your address bar instead -> <strong><a href="{{ route('register.confirmation') }}">{{ route('register.confirmation', ['code' => $code ]) }}</a></strong>.<br>
<br>
